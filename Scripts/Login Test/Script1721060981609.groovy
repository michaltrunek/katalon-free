...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/user name input'), 'standard_user')
...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), 'Name')
...
WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/div_Your order has been dispatched, and wil_39390f'))
